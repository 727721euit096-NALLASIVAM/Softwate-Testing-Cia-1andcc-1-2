...
public class NewTest_1 {
 ...
 Thread.sleep(2000);
 d.findElement(By.xpath("//*[@id=\"BE_flight_form_wrapper\"]/div[1]/div[2]/ul/li[1]/ul/li[1]/div/div/ul/div/div/div/li[4]")).click();
 Thread.sleep(2000);
 d.findElement(By.xpath("//*[@id=\"BE_flight_form_wrapper\"]/div[1]/div[2]/ul/li[1]/ul/li[3]/div/div/ul/div/div/div/li[3]")).click();
 Thread.sleep(2000);
